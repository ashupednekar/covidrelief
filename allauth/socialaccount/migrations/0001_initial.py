    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.CharField(help_text='App ID, or consumer key', max_length=100, verbose_name='frontend id')),
                ('secret', models.CharField(help_text='API secret, frontend secret, or consumer secret', max_length=100, verbose_name='secret key')),
